    ...
    return (
        <div className="inventory-filters">
            <ButtonGroup variant="outlined" color="primary">
                ...
                <Button onClick={() => onFilterChange('resources')} variant={filter === 'resources' ? 'contained' : 'outlined'} className="custom-button">Materials</Button>
            ...
            {filter === 'resources' && (
                <ButtonGroup variant="outlined" color="secondary" className="subcategory-group">
                    <Button onClick={() => onSubFilterChange('all')} variant={subFilter === 'all' ? 'contained' : 'outlined'} className="custom-button">All Materials</Button>
                    <Button onClick={() => onSubFilterChange('stone')} variant={subFilter === 'stone' ? 'contained' : 'outlined'} className="custom-button">Stone</Button>
                    <Button onClick={() => onSubFilterChange('wood')} variant={subFilter === 'wood' ? 'contained' : 'outlined'} className="custom-button">Wood</Button>
                    <Button onClick={() => onSubFilterChange('iron')} variant={subFilter === 'iron' ? 'contained' : 'outlined'} className="custom-button">Iron</Button>
                </ButtonGroup>
            )}
        </div>
    );
